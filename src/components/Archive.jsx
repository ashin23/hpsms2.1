  ...
  return (
    <div className="">
      <div className=" h-screen">
        ...
        <div className=" p-3  w-[100%] z-10  pl-20 justify-center bg-white shadow-[0_1px_60px_-15px_rgba(0,0,0,0.3)] overflow-scroll overflow-x-hidden h-[490px] rounded-[60px] rounded-e-none ">
